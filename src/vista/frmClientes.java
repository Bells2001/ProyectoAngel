        ...
        initComponents();
         tblClientes.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (selectedRow >= 0) {
                    txtId.setText(tblClientes.getValueAt(selectedRow, 0).toString());
                    txtDescripcion.setText(tblClientes.getValueAt(selectedRow, 1).toString());
                    txtDireccion.setText(tblClientes.getValueAt(selectedRow, 2).toString());
                    txtTelefono.setText(tblClientes.getValueAt(selectedRow, 3).toString());
                    txtRuc.setText(tblClientes.getValueAt(selectedRow, 3).toString());
                }
            }
        });
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DESCIRPCION", "DIRECCION", "TELEFONO", "RUC"
            }
        ));
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(136, 136, 136)
                                        .addComponent(txtRuc, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)))
